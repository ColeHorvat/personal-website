    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="py-10 px-5 float-left text-center lg:text-left">
                ...
                <h3 className="text-xl">I&apos;m a Full-Stack Web Developer and Game Developer based out of Vancouver, BC! <br />Currently working as a <span className="font-medium">Web Development Consultant</span> at <span className="font-medium underline text-sky-500"><a href="https://www.kaianalytics.com/" target="_blank" rel="noreferrer">Kai Analytics!</a></span></h3>
            </div>
